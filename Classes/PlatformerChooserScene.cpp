#include "PlatformerChooserScene.h"
#include "helpers.h"
...
namespace Platformer
{
	...
	void ChooserScene::btnBackPressed(Ref*)
	{
		...
		Director::getInstance()->replaceScene(
			TransitionSlideInL::create(1.0f, ChooserScene::scene(offset - rCount*lCount)));
	}
	...
	void ChooserScene::btnNextPressed(Ref*)
	{
		PlayEffect("page_turn_4.wav");
		Director::getInstance()->replaceScene(
			TransitionSlideInR::create(1.0f, ChooserScene::scene(offset + rCount*lCount)));
	}
	...
	void ChooserScene::btnLevelPressed(Ref* pSender)
	{
		...
		Director::getInstance()->pushScene(TransitionFade::create(0.75f, 
			PlatformerScene::createScene()));
	}
